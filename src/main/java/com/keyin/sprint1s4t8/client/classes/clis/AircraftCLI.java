...
//        List<AircraftModel> aircraftModels = getAircraftClient().getAllAircrafts();
//    }
//
//
//}
//// Review Jamies Project Structure For CLIs. Need only one


package com.keyin.sprint1s4t8.client.cli;

import com.keyin.sprint1s4t8.client.AircraftClient;
import com.keyin.sprint1s4t8.client.classes.models.AircraftModel;
